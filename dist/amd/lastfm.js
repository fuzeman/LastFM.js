(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("whatwg-fetch"), require("crypto-js/enc-hex"), require("crypto-js/md5"), require("lodash-amd/merge"), require("querystring"));
	else if(typeof define === 'function' && define.amd)
		define(["whatwg-fetch", "crypto-js/enc-hex", "crypto-js/md5", "lodash-amd/merge", "querystring"], factory);
	else if(typeof exports === 'object')
		exports["lastfm"] = factory(require("whatwg-fetch"), require("crypto-js/enc-hex"), require("crypto-js/md5"), require("lodash-amd/merge"), require("querystring"));
	else
		root["lastfm"] = factory(root["whatwg-fetch"], root["crypto-js/enc-hex"], root["crypto-js/md5"], root["lodash-amd/merge"], root["querystring"]);
